    ...
    <View style={styles.container}>
      ...
      <View style={styles.modulesContainer}>
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate('Class_5_Algebra')}
        >
          <Text style={styles.moduleText}>Module 1: Algebra</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={styles.moduleItem}
          onPress={() => navigation.navigate('Class_5_Gemoetry')}
        >
          <Text style={styles.moduleText}>Module 2: Geometry</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={styles.moduleItem}
